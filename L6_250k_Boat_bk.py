...
#เช็คทุก pattern ต้องไม่ซ้ำกัน ยกเว้น1และ2
    ...
    if set < 11 :
        ...
        #เศษ 1                
            ...
            #step1 จะสลาก lot แรกก่อน เช่น ถ้าใส่ชุด 21 ชุด จะจัดสลากที่15ชุดก่อน
            for i in range(job1) :
                if (pattern == 4) :
                    insert2DataFrame(numSet,numBook,pattern,i) 
                    numSet = 0
            ...
            #step2 จะสลาก lot 2 เช่น ถ้าใส่ชุด 21 ชุด จะจัดสลากที่15ชุดแรกแล้ว จัดอีก5ชุดหลังต่อ
            numSet = 0
            pattern = 0
            ...
            for i in range(job1,job2) :
                if (pattern == 4) :
                    insert2DataFrame(numFinalSet,numFinalBook,pattern,i)
                    numSet = 0  
                    pattern = 0                  
                    numBook += 1
            ...
            for i in range(job2,loopBook) :
                if (pattern == 0) :
                    insert2DataFrame(numSet,numBook2,pattern,i)
                    numSet += 1
                    pattern += 1
                elif (pattern == 1) :
                    insert2DataFrame(numSet,numBook2,pattern,i)
                    ...
                    insert2DataFrame(numSet,numBook3,pattern,i)
                    numSet += 1
                    pattern += 1
                elif (pattern == 3) :
                    insert2DataFrame(numSet,numBook3,pattern,i)
                    ...
                    insert2DataFrame(numFinalSet,numBook4,pattern,i)
                    numSet = 0  
                    pattern = 0
        ...
        #เศษ 3   
            ...
            #step1 จะสลาก lot แรกก่อน เช่น ถ้าใส่ชุด 23 ชุด จะจัดสลากที่ 15 ชุดก่อน
            for i in range(job1) :
                if (pattern == 4) :
                    insert2DataFrame(numSet,numBook,pattern,i) 
                    numSet = 0
            ...
            #step2 จะสลาก lot 2 เช่น ถ้าใส่ชุด 23 ชุด จะจัดสลากที่ 15 ชุดแรกแล้ว จัดอีก 5 ชุดหลังต่อ
            numSet = 0
            pattern = 0
            numFinalSet = 4 #ค่าเริ่มต้นเพื่อเพิ่มชุดสุดท้าย pattern 5  
            numFinalBook = 0 #ค่าเริ่มต้นเล่ม ของชุดสุดท้าย pattern 5   
            ...
            for i in range(job2,loopBook) :
                if (pattern == 0) :
                    ...
                    insert2DataFrame(numFinalSet,numBook3,pattern,i)
                    numSet = 0  
                    pattern = 0
        ...
        #เศษ 4                
            ...
            for i in range(job1,loopBook) :
                if (pattern == 4) :
                    insert2DataFrame(numFinalSet,numBook2,pattern,i)
                    numSet = 0  
                    pattern = 0                  
                    numBook += 1
        ...
        df.to_excel(path+"L6_"+str(set)+"k.xlsx",index=False) #สร้างไฟล์ excel